#!/usr/bin/env python3
import json, string, threading, queue, csv, time, random
...
if __name__ == '__main__':
    ...
    prepared_phrases_list = phrases + phrases + phrases
    random.shuffle(prepared_phrases_list)

    for phrase_dict in prepared_phrases_list:
...
list = phrases + phrases + phrases
    complete_phrase_dict_list =
